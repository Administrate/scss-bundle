...
var Bundler = /** @class */ (function () {
    ...
    Bundler.prototype.resolveImport = function (importData, includePaths) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var error_1, underscoredDirname, underscoredBasename, underscoredFilePath, underscoreErr_1, cssFilePath, cssErr_1, remainingIncludePaths;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 6:
                        ...
                        cssFilePath = importData.fullPath.replace(/\.scss/g, ".css");
                        _a.label = 7;
                    case 7:
                        _a.trys.push([7, 9, , 10]);
                        return [4 /*yield*/, fs_extra_1.default.access(cssFilePath)];
                    case 8:
                        _a.sent();
                    ...
                    case 12: return [2 /*return*/, importData];
                }
            });
        });
    };
